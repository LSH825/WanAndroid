...
import com.lsh.wanandroid.ui.tab.TabTreeFragment;
...
public class MainActivity extends BaseActivity {
    ...
    private int[] mItemIdArray = {R.id.nav_bottom_home, R.id.nav_bottom_tree, R.id.nav_bottom_project, R.id.nav_bottom_mine};
    ...
    private List<Fragment> getTabFragment() {
        ...
        list.add(TabTreeFragment.newInstance());
