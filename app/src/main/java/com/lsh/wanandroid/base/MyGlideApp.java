...
public final class MyGlideApp extends AppGlideModule {
    ...
    public void registerComponents(Context context, Glide glide, Registry registry) {
        ...
        com.lsh.common.gifdecoder.ByteBufferGifDecoder byteBufferGifDecoder =
                new com.lsh.common.gifdecoder.ByteBufferGifDecoder(context, imageHeaderParsers, glide.getBitmapPool(), glide.getArrayPool());
